    ...
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leaing-7 font-montserrat text-white-400
          sm:max-w-sm">Get shoes ready for the new term at
          your nearest Nike stoore. Find your perfect size in store. Get Rewards!
          </p>
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  ...
                  hover:text-slate-gray cursor-pointer" key={link.name}><a href="#">{link.name}</a></li>
                ))}
              </ul>
            </div>
          ))}
