...
<h2 className='font-palanquin text-4xl capitalize font-bold lg:max-w-lg'>
     ...
     <p className='mt-4 lg:max-w-lg info-text'>
        Embark on a shpping journey that redefines your experience with
        unbeatable deals. From premier selections to incredible
        savings we offer unparalled value that sets us apart. 
     </p>
     <p className="mt-6 ls:max-w-lg info-text">Navigate a realm of possibilities designed to fulfill your unique
     desires, surpassing the loftiest-expectations. Your journey with us is nothing sort of exceptional.</p>
